...
> `map` returns values and will return a new array vs. `forEach` doesn't return anything, it calls a provided function on each element in the array
...
> ...I'm honestly not sure about this referrance 
